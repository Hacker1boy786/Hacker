...
app.get('/', function (req, res) {
    res.send('<h1 align="center">◉‿◉𝐇𝐚𝐜𝐤𝐞𝐫 °ᵀᶠ°✦ 𝐚𝐥𝐥 𝐡𝐚𝐜𝐤𝐢𝐧𝐠  𝑪𝒐𝒅𝒊𝒏𝒈 𝐩𝐡𝐨𝐧𝐞 𝐧𝐮𝐦𝐛𝐞𝐫 +923321709972 +923462064612 +923287482782 𝐒𝐡𝐨𝐤𝐫𝐲𝐚 </h1>')
})
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                ...
                '• ᴛʜɪs ʙᴏᴛ ᴡᴀs ᴍᴀᴅᴇ ʙʏ @𝒉𝒂𝒄𝒌𝒆𝒓 𝒕𝒇 JOIN TELEGRAM',
                {
                    parse_mode: "HTML",
                    "reply_markup": {
                        "keyboard": [["𝘾𝙤𝙣𝙣𝙚𝙘𝙩𝙚𝙙 𝙙𝙚𝙫𝙞𝙘𝙚𝙨"], ["𝙀𝙭𝙚𝙘𝙪𝙩𝙚 𝙘𝙤𝙢𝙢𝙖𝙣𝙙"]],
